...
class XLM_model:
    ...
    def encode(self, sentences: list, max_len: int):
        ...
        # Actually the padding the Padding is done with the ID = 0
...
if __name__ == '__main__':
    ...
    # max value = 145
    # Load XLM model
    XLM_model = XLM_model("xlm-mlm-100-1280", gpu=GPU)
    max_len = MAX_LEN
    # Open file
    ...
    for lang in lang_arr:
        ...
        out_fname = "../output/XLM_MLM/newstest2012.{}.embed.npy".format(lang)
